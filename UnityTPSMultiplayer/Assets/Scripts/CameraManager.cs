...
{
    [SerializeField][Range(-5, 5)] private float _defaultSensitivity = 1.5f; public static float defaultSensivity { get { return singleton._defaultSensitivity; } }
    [SerializeField][Range(-5, 5)] private float _aimingSensitivity = 0.5f; public static float aimingSensivity { get { return singleton._aimingSensitivity; } }
