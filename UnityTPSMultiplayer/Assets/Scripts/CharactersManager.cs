...
public class CharactersManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        RealtimeNetworking.OnUnEquipCharacterEquipment += OnUnEquipCharacterEquipment;
    ...
    private void OnUnEquipCharacterEquipment(RealtimeNetworking.SetEquipmentStatusResponse response)
    {
