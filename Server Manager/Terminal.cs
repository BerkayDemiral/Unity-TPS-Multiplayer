...
namespace DevelopersHub.RealtimeNetworking.Server
{
    class Terminal
    {
        ...
        public const string sqlite_database_file_path = @"C:\Database\UnityTPSMultiplayer.db";
        public const string log_directory_path = @"C:\Log\realtime_networking\";

        #region Extensions
        public const string netcode_server_executable_path = @"C:\Users\Berkay\Desktop\Unity Online\Netcode Server\UnityTPSMultiplayer.exe";
